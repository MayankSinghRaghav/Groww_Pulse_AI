"""
Generates a role-specific, Groww-branded PDF weekly pulse note using fpdf2.
"""
import logging
import datetime
import os
...
class GrowwPDF(FPDF):
    def header(self):
        ...
        self.cell(30, 10, "GROWW", new_x=XPos.RIGHT, new_y=YPos.TOP)
    ...
    def footer(self):
        ...
        self.cell(0, 10, "CONFIDENTIAL | Generated by Groww Pulse AI Engine", align="C")
...
def generate_all_pdf_notes(insights_data: dict, action_ideas: Any) -> Dict[str, str]:
    ...
    for role in ["Product Team", "Support Team", "Leadership"]:
        filename = f"Groww_Pulse_{role.replace(' ', '_')}_{today_str}.pdf"
